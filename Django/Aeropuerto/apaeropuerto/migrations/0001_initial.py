    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nombre', models.CharField(max_length=2, verbose_name='Aeropuerto')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('destino', models.ManyToManyField(related_name='vuelos_de_destino', to='apaeropuerto.aeropuerto')),
                ('origen', models.ManyToManyField(related_name='vuelos_de_origen', to='apaeropuerto.aeropuerto')),
            ],
        ),
        migrations.CreateModel(
            name='Silla',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('vuelo', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='apaeropuerto.vuelo')),
            ],
        ),
        migrations.CreateModel(
            name='VueloAerolinea',
        ...
        migrations.AddField(
            model_name='vuelo',
            name='aerolinea',
            field=models.ManyToManyField(through='apaeropuerto.VueloAerolinea', to='apaeropuerto.aerolinea'),
        ),
    ]
